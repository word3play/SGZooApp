        ...
        try
        {
            ...
            if (kkAppEng.getContentMgr().isEnabled())
            {
                content = kkAppEng.getContentMgr()
                        .getContentForId(1, KKConstants.CONTENTID_RETURNS_INFO);
            }

            if (content != null && content.length > 0)
            {
                returnsContent = content[0].getDescription().getContent();
            } else
            {
