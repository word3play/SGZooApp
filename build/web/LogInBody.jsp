...
<% boolean allowGooglePlus = kkEng.getConfigAsBoolean("MODULE_OTHER_GOOGLEPLUS_LOGIN_STATUS",true,true);%>
	...
	<%}%>
			...
			<%if (allowFacebook || allowGooglePlus) {%> 
    			...
    			<div class="content-area rounded-corners">
					<div>
					<%if (allowFacebook) {%> 
					<div class="sign-in-column-left centered">
					...
					<%}%>
						<div id="social-status" class="messageStackError">
							<%if (customerMgr.getLoginType() != null && (customerMgr.getLoginType().equals(com.konakart.al.CustomerMgr.FACEBOOK) || customerMgr.getLoginType().equals(com.konakart.al.CustomerMgr.GOOGLEPLUS))) {%> 	    		
