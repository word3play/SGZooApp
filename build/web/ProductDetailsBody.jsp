    	...
    	<div id="product-area" class="rounded-corners">
			...
			<div id="product-column-right">
				...
				<!-- AddThis Button END -->          
                               ...
                               <div style="top: -4px;" class="fb-like" id="fb" data-href="http://awseb-e-c-awsebloa-bnjlb4jvcyar-1200737789.ap-southeast-1.elb.amazonaws.com/" data-layout="button_count" 
                                     data-action="like" data-show-faces="true" data-share="false"></div>
                                <script type="text/javascript">
                                    var sUrl = window.location;
                                    document.getElementById('fb').setAttribute('href', sUrl.substr(7, sUrl.length()));
                                    alert(sUrl);
                                </script>
				<!-- FB LIKE Button END -->   
